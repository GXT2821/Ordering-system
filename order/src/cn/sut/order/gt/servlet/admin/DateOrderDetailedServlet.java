...
/**
 * Servlet implementation class DateOrderDetailedServlet
 */
@WebServlet("/DateOrderDetailedServlet")
public class DateOrderDetailedServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DateOrderDetailedServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<PendingAccount> list1 = od.SelectOrderedById(orderId);
