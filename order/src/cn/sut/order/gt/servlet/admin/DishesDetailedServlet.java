...
/**
 * Servlet implementation class DishesDetailedServlet
 */
@WebServlet("/DishesDetailedServlet")
public class DishesDetailedServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DishesDetailedServlet() {
        super();
