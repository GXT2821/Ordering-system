...
<script type="text/javascript">
	...
	function addDishesinfo(){//初始化数据
		...
		$.ajax({
	        type: "POST",
	        url: "/order/AddDishesInfoServlet",
	        data: {
	...
	function dishesCallback() {
		var dishesName=$("#dishesName").val();
		if(dishesName=="" || dishesName==null){
			if (formstate & 1 != 0) {
				formstate = formstate ^ 1;
			}
    		$("#nameerror").html("菜品名称必须填写！");
		}else{
			$.ajax({
				 type: "POST",
			        url: "/order/DishesIsEmptyServlet",
			        data: {
			        	dishesName : dishesName,
			        },
			        dataType: "json",
							...
							<div>
								...
								<form class="form-horizontal" role="form"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea rows="8" class="form-control" name="dishesTxt" id="dishesTxt"></textarea>
										</div>
									...
									<input type="hidden" value="img/dishes/1.jpg" id="dishesImg"
										name="dishesImg" />

									<div class="form-group">
										<div class="col-sm-offset-2 col-sm-10">
											<input type="button" class="btn btn-danger" id="addbtu"
												disabled="disabled" value="添加菜品" onclick="addDishesinfo()"/>
										</div>
									</div>
								</form>
							</div>
