				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						<div style="text-align: right;">
							当前在线人数:<span id="sessionNum">${count }</span>,其中后厨人员<span id="kitchenNum">${kitchencount }</span>人
						</div>
							...
							<table class="table table-striped">
								...
								<c:forEach items="${ requestScope.list}" var = "list">
										...
										<td><i
											...
											class="icon-sitemap icon-large" title="查看人员详情"
											onclick="userinfo(${list.userId})"></i> &nbsp;&nbsp;<i
											style="cursor: pointer; font-size: 14;"
											onmouseover="this.style.color='orange'"
											onmouseout="this.style.color='black'"
											class=" icon-remove-sign icon-large" title="删除人员"
											onclick="deleteuser(${list.userId})"></i></td>
									</tr>
									</c:forEach>
