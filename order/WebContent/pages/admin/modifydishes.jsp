...
<%@ page import="cn.sut.order.gt.vo.DishesInfo" %>
...
<script type="text/javascript">
		...
		$.ajaxFileUpload({ 
			...
			success: function (data, status)  {//服务器成功响应处理函数
				if(data.message!=""){
					...
					$("#dishesImg1").attr("src", data.url);
					$("#dishesImg").val(data.url)
				}
			},
	...
	function updateDishesinfo(){//初始化数据
		var dishesName=$("#dishesName").val();
		var dishesDiscript=$("#dishesDiscript").val();
		var dishesTxt=$("#dishesTxt").val();
		var dishesPrice=$("#dishesPrice").val();
		var dishesId=$("#dishesId").val();
		var dishesImg=$("#dishesImg").val();
		var recommend;
		...
		$.ajax({
	        type: "POST",
	        url: "/order/UpdateDishesInfoServlet",
	        data: {
	        ...
	        success: function (json) {
	        	if(json.msg==""){
	        		alert("修改成功！");
	        		window.location.href="pages/admin/dishesadmin.jsp";
	        	}else{
	        		alert("操作失败！");
	        	}
					...
					<div class="row" style="padding-top: 0px">
							...
							<div>
								...
								<form class="form-horizontal" role="form"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="dishesDiscript"
												value="${list.dishesDiscript }" name="dishesDiscript"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea rows="8" class="form-control" id="dishesTxt" name="dishesTxt">${list.dishesTxt }</textarea>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="dishesPrice"
												...
												value="${list.dishesPrice }" onblur="checkprice()">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											${list.recommend==1?"checked=\"checked\"":"" }
									...
									<input type="hidden" value="${list.dishesId }" id="dishesId"
										name="dishesId" /> <input type="hidden" value="${list.deshesImg }"
										id="dishesImg" name="dishesImg" />

									<div class="form-group">
										<div class="col-sm-offset-2 col-sm-10">
											<input type="button" class="btn btn-danger" id="addbtu"
												disabled="disabled" value="修改菜品" onclick="updateDishesinfo()"/>
										</div>
									</div>
								</form>
							</div>
						...
						<div style="width: 25%;display: inline-block;vertical-align: top;">
							...
							<div style="text-align: center;">
								<img id="dishesImg1" src="${list.deshesImg }"
