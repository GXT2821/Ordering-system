		...
		<form role="form" method="post" action="LoginServlet">
			...
			<div class="form-group login-text" style="text-align: left;">
				<label>用户名:</label> <input type="text" class="form-control"
					name="userAccount" id="userAccount" placeholder="请输入您的用户名" required autofocus >
			</div>
			<div class="form-group login-text" style="text-align: left;">
				<label>密&nbsp;&nbsp;码:</label> <input type="password"
					class="form-control" name="userPass" id="userPass" placeholder="请输入您的密码" required >
			</div>
